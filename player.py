...
class PlayerData(object):
    ...
    def __init__(self):
        ...
        self.set_last_played_file_path()
    ...
    def set_last_played_file_path(self):
...
class VideoPlayer(player_Ui.Ui_MainWindow, QtGui.QMainWindow):
    ...
    def connect_signals_and_slots(self):
        ...
        self.data.phonon_media_obj.seekableChanged.connect(self.seekAndPlay)
    ...
    def open_file_browser(self):
        ...
        if file_path:
            ...
            # self.data.save_last_selected_directory(file_path)
